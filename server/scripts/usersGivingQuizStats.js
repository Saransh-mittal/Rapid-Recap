...
async function usersGivingQuizStats(startDate = null, endDate = null) {
  ...
  console.log(populatedQuizAttemptsByUsers);
}

// Example usage:
// View users' quiz attempts for a specific date range
const startDate = new Date("2024-06-15T00:00:00Z"); // ISO 8601 format
const endDate = new Date("2024-06-15T23:59:59Z"); // ISO 8601 format
usersGivingQuizStats(startDate, endDate).catch((err) => console.error(err));
