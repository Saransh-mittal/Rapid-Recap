...
`,
  ...
  <div style="max-width:600px; margin:0 auto; background:white; padding:30px; border-radius:10px; box-shadow:0 0 20px rgba(0,0,0,0.1);">
    ...
    <div style="padding:20px 0;">
      ...
      <div style="text-align:center; margin:30px 0;">
        <a href="https://www.rapidrecap.co.in" style="display:inline-block; background-color:#00466a; color:#fff; text-decoration:none; padding:15px 30px; border-radius:5px; font-size:1em;">Complete Your 5th Quiz</a>
      </div>
...
`,
  ...
  <div style="max-width:600px; margin:0 auto; background:white; padding:30px; border-radius:10px; box-shadow:0 0 20px rgba(0,0,0,0.1);">
    ...
    <div style="padding:20px 0;">
      ...
      <div style="text-align:center; margin:30px 0;">
        <a href="https://www.rapidrecap.co.in" style="display:inline-block; background-color:#00466a; color:#fff; text-decoration:none; padding:15px 30px; border-radius:5px; font-size:1em;">Take Your 6th Quiz Now</a>
      </div>
