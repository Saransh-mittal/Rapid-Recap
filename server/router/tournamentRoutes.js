...
router.get('/completed-tournaments', getCompletedTournaments)
router.get('/hall-of-champions/leaders', getLatestTournamentLeaders)
router.get('/leaders/:tournamentId', getTournamentLeaders)
