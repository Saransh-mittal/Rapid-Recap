...
7. If the question requires remembering numerical data, specific dates, or names(except author names and small names.), assign a higher difficulty level between 0.55 to 0.99 . Give These things higher priority while assigning difficulty.
