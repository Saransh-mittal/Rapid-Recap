import{j as e}from"./index-c313bc2e.js";import p from"./ButtonComponent-4d94d839.js";import g from"./ButtonGradient-e94eb035.js";import{u as x}from"./useTranslation-c6640be7.js";import{af as f,ak as i,Q as u}from"./text-3a919685.js";import{F as t}from"./progress-e31f4cb5.js";import{H as o}from"./heading-4acb784e.js";import"./useSafeSound-d7f7f27b.js";import"./loadingProgressSlice-7c8cd0f0.js";import"./i18next-c75e253c.js";import"./react-redux-c36218eb.js";import"./use-breakpoint-value-bc0d47d3.js";import"./index-d58452bc.js";import"./i18nInstance-5a5667a1.js";import"./button-ff7e862a.js";import"./use-toast-b6a15eb2.js";const h="/images/rocket.webp",Y=({score:n,isOpen:a,submitLoad:s,boost:l,onViewReport:m})=>{const{t:r}=x("BoostedSubmittedQuizInterface"),d={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards, animate 0.2s ease infinite"},c={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards"};return e.jsx(f,{direction:"bottom",in:a,offsetY:"20px",style:{zIndex:10},children:e.jsxs(t,{position:"relative",flexDirection:"column",w:"100%",height:"100%",justifyContent:"center",alignItems:"center",color:"white",css:`
          @property --angle {
            syntax: '<angle>';
            initial-value: 90deg;
            inherits: true;
