import{j as e}from"./index-574cf661.js";import p from"./ButtonComponent-f3424074.js";import g from"./ButtonGradient-95015093.js";import{u as x}from"./useTranslation-143ff775.js";import{af as f,ak as i,O as u}from"./text-fe7913f6.js";import{F as t,H as o}from"./heading-c39a679f.js";import"./useSafeSound-10c62d87.js";import"./inventorySlice-eeeb505e.js";import"./i18next-c75e253c.js";import"./react-redux-e1b49112.js";import"./use-breakpoint-value-2fea5743.js";import"./index-aca40a36.js";import"./i18nInstance-5a5667a1.js";import"./use-form-control-e4bdff24.js";import"./button-e4d7c8a3.js";import"./use-toast-94051cea.js";const h="/images/rocket.webp",Y=({score:n,isOpen:a,submitLoad:s,boost:l,onViewReport:d})=>{const{t:r}=x("BoostedSubmittedQuizInterface"),m={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards, animate 0.2s ease infinite"},c={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards"};return e.jsx(f,{direction:"bottom",in:a,offsetY:"20px",style:{zIndex:10},children:e.jsxs(t,{position:"relative",flexDirection:"column",w:"100%",height:"100%",justifyContent:"center",alignItems:"center",color:"white",css:`
          @property --angle {
            syntax: '<angle>';
            initial-value: 90deg;
            inherits: true;
