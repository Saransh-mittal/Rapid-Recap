import{u as x,w as e,F as t,T as i,P as g}from"./index-0db3c65d.js";import f from"./ButtonComponent-40a5178b.js";import u from"./ButtonGradient-788a9011.js";import{S as h}from"./slide-fade-a37d81de.js";import{H as n}from"./heading-91e4aaa1.js";import"./use-breakpoint-value-ce2a08a3.js";import"./responsive-229b9a70.js";import"./transition-utils-ac1178ea.js";const b="/images/rocket.webp",z=({score:o,isOpen:a,submitLoad:s,onViewReport:l,isBoosted:d,isQuinBoostAvailable:c})=>{const{t:r}=x("BoostedSubmittedQuizInterface"),m={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards, animate 0.2s ease infinite"},p={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards"};return e.jsx(h,{direction:"bottom",in:a,offsetY:"20px",style:{zIndex:10},children:e.jsxs(t,{position:"relative",flexDirection:"column",w:"100%",height:"100%",justifyContent:"center",alignItems:"center",color:"white",css:`
          @property --angle {
            syntax: '<angle>';
            initial-value: 90deg;
            inherits: true;
