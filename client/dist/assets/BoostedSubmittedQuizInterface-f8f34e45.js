import{j as e}from"./index-b621db24.js";import p from"./ButtonComponent-150bb9e5.js";import g from"./ButtonGradient-f5429237.js";import{u as x}from"./useTranslation-837dfd8c.js";import{af as f,ak as i,O as u}from"./text-0148cb10.js";import{F as t,H as o}from"./heading-d568c4ff.js";import"./useSafeSound-0b9c27c5.js";import"./inventorySlice-4f3d3300.js";import"./i18next-c75e253c.js";import"./react-redux-fe294fac.js";import"./use-breakpoint-value-dc96d310.js";import"./index-528abccd.js";import"./i18nInstance-5a5667a1.js";import"./use-form-control-9e920612.js";import"./button-a549163b.js";import"./use-toast-ebf9bc5c.js";const h="/images/rocket.webp",Y=({score:n,isOpen:a,submitLoad:s,boost:l,onViewReport:d})=>{const{t:r}=x("BoostedSubmittedQuizInterface"),m={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards, animate 0.2s ease infinite"},c={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards"};return e.jsx(f,{direction:"bottom",in:a,offsetY:"20px",style:{zIndex:10},children:e.jsxs(t,{position:"relative",flexDirection:"column",w:"100%",height:"100%",justifyContent:"center",alignItems:"center",color:"white",css:`
          @property --angle {
            syntax: '<angle>';
            initial-value: 90deg;
            inherits: true;
