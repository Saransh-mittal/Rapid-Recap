import{j as e}from"./index-468819cc.js";import p from"./ButtonComponent-c496449d.js";import g from"./ButtonGradient-5fa96b9d.js";import{u as x}from"./useTranslation-e9cdead2.js";import{af as f,ak as i,O as u}from"./text-986efc70.js";import{F as t,H as o}from"./heading-52e1e3bd.js";import"./useSafeSound-383ec49e.js";import"./inventorySlice-44b4abe2.js";import"./i18next-c75e253c.js";import"./react-redux-fd4eb046.js";import"./use-breakpoint-value-d8f1a556.js";import"./index-3ef9a21e.js";import"./i18nInstance-5a5667a1.js";import"./use-form-control-8fd9bedd.js";import"./button-9b9e8d32.js";import"./use-toast-284bd46b.js";const h="/images/rocket.webp",Y=({score:n,isOpen:a,submitLoad:s,boost:l,onViewReport:d})=>{const{t:r}=x("BoostedSubmittedQuizInterface"),m={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards, animate 0.2s ease infinite"},c={position:"relative",bottom:"-500%",animation:"animate-rocket 2s ease forwards"};return e.jsx(f,{direction:"bottom",in:a,offsetY:"20px",style:{zIndex:10},children:e.jsxs(t,{position:"relative",flexDirection:"column",w:"100%",height:"100%",justifyContent:"center",alignItems:"center",color:"white",css:`
          @property --angle {
            syntax: '<angle>';
            initial-value: 90deg;
            inherits: true;
