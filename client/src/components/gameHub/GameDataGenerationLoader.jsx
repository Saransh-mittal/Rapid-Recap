...
const GameDataGenerationLoader = memo(
  ({
    ...
    useEffect(() => {
      const newStepIndex = processingSteps.findIndex(
        p => displayedProgress < p.step,
      )
      setCurrentStepIndex(
        newStepIndex === -1 ? processingSteps.length - 1 : newStepIndex,
      )
    }, [displayedProgress, processingSteps])

    const currentStepData = processingSteps[currentStepIndex]
...
GameDataGenerationLoader.displayName = 'GameDataGenerationLoader'
