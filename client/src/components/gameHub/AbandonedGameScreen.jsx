...
// Moved static data outside the component to prevent re-creation
const gameTypeNames = {
...
// Moved pure function outside the component
...
const AbandonedGameScreen = memo(
  ({
    abandonmentInfo,
    articleId,
    onRetryGame,
...
AbandonedGameScreen.displayName = 'AbandonedGameScreen'
