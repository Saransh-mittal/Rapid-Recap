...
const GameExitWarningDialog = memo(
  ({
    isOpen,
    onClose,
    onConfirmExit,
    ...
    const exitInfo = useMemo(
      () => exitReasonInfoMap[exitReason] || exitReasonInfoMap.navigation_away,
      [exitReason],
    )
              ...
              >
                ...
                >
                  ...
                  <AlertDescription lineHeight="1.4">
                    You are about to leave your active game session. Your
                    current progress will be automatically saved.
                  </AlertDescription>
                </Alert>
              </MotionBox>
...
GameExitWarningDialog.displayName = 'GameExitWarningDialog'
