...
const LogoutButton = ({ handleLogout }) => {
  ...
  return (
    <>
      <button id="logoutButton" className="logoutButton logoutButton--light">
        <svg className="svgClass doorway" viewBox="0 0 100 100">
        ...
        <svg className="svgClass figure" viewBox="0 0 100 100">
        ...
        <svg className="svgClass door" viewBox="0 0 100 100">
          <path d="M93.4 86.3H58.6c-1.9 0-3.4-1.5-3.4-3.4V17.1c0-1.9 1.5-3.4 3.4-3.4h34.8c1.9 0 3.4 1.5 3.4 3.4v65.8c0 1.9-1.5 3.4-3.4 3.4z" />
