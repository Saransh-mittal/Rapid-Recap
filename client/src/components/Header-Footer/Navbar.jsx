...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Navbar brand */}
        <Flex className={`navbar-brand ${isHamburgerOpen ? " mb-5" : ""}`}>
          <NavLink to="/">
            <Heading fontSize={"2rem"}>
              📻 {state.show && "Rapid Recap"}
            </Heading>
          </NavLink>
        </Flex>
        ...
        >
          ...
          {!isHamburgerOpen && !state.show ? (
            <>
              <Flex className="inbox-button-base">
                <Button
                  display={{ base: "flex", lg: "none" }}
          ...
          {!state.show && (
            <Flex className="streak-tracker-base">
              <Flex
                justifyContent={"center"}
                alignItems={"center"}
                gap={1}
      ...
      {!state.show && (
        <Flex gap={3}>
          <Flex className="inbox-button-lg">
            <Button
          ...
          <Flex className="streak-tracker-lg">
            <Flex
              justifyContent={"center"}
              alignItems={"center"}
              gap={1}
