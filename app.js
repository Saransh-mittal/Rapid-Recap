...
const soloDrillRoutes = require('./router/soloDrillRoutes')
const customDrillRoutes = require('./router/customDrillRoutes')
...
async function initializeServer() {
  try {
    ...
    apiRouter.use('/solo-drill', soloDrillRoutes)
    apiRouter.use('/custom-drill', customDrillRoutes)
